    ...
    <>
      <section className="py-16 relative" id="get-started" ref={ctaRef} style={{
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 opacity-0">
          ...
          {/* Additional verification option for landlords */}
          <div className="text-center mt-12">
            <p className="text-white/90 mb-4">Are you a landlord looking to list your property?</p>
            <button 
              onClick={() => setShowLandlordForm(true)}
              className="bg-white/20 text-white px-8 py-3 rounded-full font-medium hover:bg-white/30 transition-colors border border-white/30"
            >
              Verify as Landlord
            </button>
          </div>
