...
const TestimonialsShowcase = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: "The virtual tours feature is revolutionary! I was able to shortlist properties from Abuja and secure my Lagos apartment before even visiting. The transparency in pricing is refreshing.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Moving to Lagos for my residency was stressful until I found PhCityRent. The verified agents, secure payments, and neighborhood insights made everything seamless. Thank you!",
    ...
    },
    {
      ...
      rating: 5,
      text: "The market intelligence feature helped me negotiate the best deal. PhCityRent's data-driven approach to property rental is exactly what Nigeria needs. Outstanding service!",
